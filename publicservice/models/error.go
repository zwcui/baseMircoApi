...
const (
	...
	BannerError100          = "Banner100###资源不存在"

	LoginError100           = "Login100###此手机号码没有绑定辣课账号或手机号不正确"
	LoginError200           = "Login200###验证码错误"
	LoginError300           = "Login300###该手机号已被绑定"

	RecentActivityError100  = "RecentActivity100###未找到对应的近期活动"

	AppConfigError100		= "AppConfig100###forcedUpdate 必须为0或者1"
	AppConfigError200		= "AppConfig200###配置信息不存在"

	VersionError100			= "Version100###未找到最新版本"

	QuestionnaireError100	= "Questionnaire100###解析回答失败"
	QuestionnaireError200	= "Questionnaire200###未查询到相关结果"
	QuestionnaireError300	= "Questionnaire300###未找到用户信息，请确认已关注公众号或者注册app"
	QuestionnaireError400	= "Questionnaire400###请您先回答问卷再领取课程~"
	QuestionnaireError500	= "Questionnaire500###您已成功领取课程欢迎免费观看！正在跳转到课程页面。"
	QuestionnaireError600	= "Questionnaire600###为了更好的为您提供服务，填写问卷前需要您授权用户的信息。"
	QuestionnaireError700	= "Questionnaire700###未找到对应的问卷信息"

	EnrollError100			= "Enroll100###您已报名，无需重复提交"
)
