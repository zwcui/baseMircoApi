...
type AppConfig struct {
	Id          		int64  			`description:"id" json:"id" xorm:"pk autoincr"`
	System             	int    			`description:"设备系统类型 1 android 2 ios" json:"system" xorm:"unique(sysVersion)" valid:"Range(1, 2)"`
	Version             string 			`description:"版本号" json:"version" xorm:"unique(sysVersion)" valid:"Required"`
	Description		 	string 			`description:"描述" json:"description"`
	ForcedUpdate        int    			`description:"是否强制更新 0：否 1：是" json:"forcedUpdate" xorm:"notnull"`
	Created             int64  			`description:"创建时间" json:"-" xorm:"created"`
}

type Version struct {
	VersionId   		int64  	 		`description:"版本Id" json:"versionId" xorm:"pk autoincr"`
	DeviceOs    		string       	`description:"设备系统" json:"deviceOs"`
	Channel	    		string       	`description:"渠道" json:"channel"`
	Version     		string       	`description:"版本号" json:"version"`
	Description 		string       	`description:"描述" json:"description"`
	FilePath    		string       	`description:"文件路径" json:"filePath"`
	Created     		int64	 		`description:"创建时间" json:"created" xorm:"created"`
	DeletedAt   		int64        	`description:"删除时间" json:"-" xorm:"deleted"`
}
...
type AppConfigListContainer struct {
	BaseListContainer
	AppConfigList  			[]AppConfig 		`description:"app配置" json:"appConfigList"`
}


type VersionContainer struct {
	BaseListContainer
	VersionList 			[]Version 			`description:"版本列表" json:"versionList"`
}
