...
func (r *ConsulRegister) RegisterService() error {
	...
	reg := &api.AgentServiceRegistration{
		...
		Check: &api.AgentServiceCheck{ // 健康检查
			...
			GRPC:     r.Service, // grpc 支持，执行健康检查的地址，service 会传到 Health.Check 函数中
			//HTTP:                           fmt.Sprintf("http://127.0.0.1:9011/v2/health/check"),
