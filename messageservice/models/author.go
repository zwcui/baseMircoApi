...
type Author struct {
	...
	IsVip				int				`description:"当前是否是会员" json:"isVip"`
	VipEndTime			int64			`description:"会员到期时间" json:"vipEndTime"`
	IdCard			    string			`description:"身份证号码" json:"idCard"`
	RealName			string			`description:"真实姓名" json:"realName"`
	LastSignInTime    	int64  			`description:"上次登录时间" json:"lastSignInTime"`
	SignInDays	    	int  			`description:"累计登陆天数" json:"signInDays"`
	RegisterSystem    	int  			`description:"注册系统，0:公众号 1:android 2:ios" json:"registerSystem"`
	RegisterChannel    	string 			`description:"注册渠道，主要为Android各大应用市场包和H5来源细分的包的统计" json:"registerChannel"`
