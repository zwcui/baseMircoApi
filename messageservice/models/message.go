...
type AppMessage struct {
	...
	Type        int    `description:"消息类型 1:购买成功消息 2:转发成功消息 3:评论成功消息 4:举报成功消息 5.下级关注通知 6：循环绑定通知 7:问卷回答成功通知 8:撤销直播通知" json:"type" `
	AppType     int    `description:"应用类型 0:app 1:公众号" json:"appType" xorm:"notnull default 0"`
	Created     int64  `description:"创建时间" json:"created" xorm:"created"`
...
type AppMessageListContainer struct {
	BaseListContainer
	AppMessageList		[]AppMessage	`description:"我的消息列表" json:"appMessageList"`
}